...
export default function ProductDetailClient({
  ...
  return (
    <>
      ...
      <main className="vl-section-shell w-full max-w-full overflow-x-hidden pt-[calc(7rem+env(safe-area-inset-top))] sm:pt-8 lg:pt-10 pb-[calc(10rem+env(safe-area-inset-bottom))] lg:pb-10">
