  ...
  return (
    <Portal>
      <div className="fixed inset-0 z-[100] flex items-center justify-center">
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-vl-border bg-vl-surface/50 backdrop-blur-sm sticky top-0 z-10 rounded-t-2xl">
            <div className="flex items-center justify-between p-4 border-b border-vl-border bg-vl-surface/50 backdrop-blur-sm sticky top-0 z-10 rounded-t-2xl">
              <div className="flex items-center justify-between p-4 border-b border-vl-border bg-vl-surface/50 backdrop-blur-sm sticky top-0 z-10 rounded-t-2xl">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      autoCapitalize="off"
                      autoCorrect="off"
                      className="w-full pl-11 pr-12 py-3 bg-white border border-vl-border rounded-xl text-base font-medium text-vl-ink shadow-sm outline-none transition-colors duration-200 placeholder:text-vl-muted focus:border-vl-primary focus:ring-1 focus:ring-vl-primary/30 transition-all sm:h-[52px] sm:text-[15px]"
                    />
                    {query && (
                      <button
                        type="button"
                  ...
                  <div className="mt-4 flex justify-center md:justify-start">
                    <div className="flex items-center gap-2 overflow-x-auto pb-2 px-4 sm:px-0 sm:pb-0">
                      {[
                        { value: "all", label: "All" },
                ...
                {/* Results */}
                <div className="overflow-y-auto max-h-[60vh] p-4 sm:p-6" role="listbox" aria-label="Search results">
                  {isLoading ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-sm text-vl-muted mb-4">No results found for "<span className="font-medium">{query}</span>"</p>
