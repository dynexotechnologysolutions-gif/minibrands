...
export default function HomeNewsletter() {
  return (
    <section className="vl-section-shell mt-16 sm:mt-24">
      <div className="flex flex-col justify-between gap-8 rounded-vl-section bg-vl-ink p-8 sm:p-12 lg:flex-row lg:items-center lg:p-20 text-white shadow-vl-medium">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex w-full max-w-md items-center gap-3 lg:w-[400px] lg:shrink-0">
