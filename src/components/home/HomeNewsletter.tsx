          ...
          <div className="flex flex-col justify-center p-5 sm:p-10 lg:p-12">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-6 flex w-full max-w-md flex-col items-stretch gap-3 sm:flex-row sm:items-center">
              ...
              <button
                suppressHydrationWarning
                type="submit"
                className="group inline-flex min-h-12 w-full shrink-0 items-center justify-center gap-2 rounded-vl-control bg-vl-primary px-6 text-sm font-semibold text-white transition duration-vl-fast hover:bg-vl-primary-strong hover:shadow-vl-medium cursor-pointer sm:w-auto"
              >
                Subscribe
