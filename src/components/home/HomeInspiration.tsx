...
export default function HomeInspiration() {
  return (
    <section className="vl-section-shell mt-16 sm:mt-24">
      <div className="grid items-center gap-8 overflow-hidden rounded-vl-section bg-vl-secondary p-8 sm:p-12 lg:grid-cols-2 lg:p-16 text-white shadow-vl-medium">
        <div className="flex flex-col justify-center py-4 max-w-[520px]">
          <Quote aria-hidden="true" className="h-14 w-14 text-vl-accent" fill="currentColor" />
          <p className="mt-8 font-vl-heading text-3xl sm:text-4xl lg:text-[48px] font-semibold leading-[1.15] tracking-[-0.03em]">
        ...
        <div className="relative w-full h-[320px] sm:h-[420px] lg:h-[500px] overflow-hidden rounded-[24px] bg-vl-ink shadow-vl-large">
          <Image
