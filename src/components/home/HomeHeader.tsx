      ...
      <header className="sticky top-0 z-50 w-full border-b border-[#ECECEC]/80 bg-white/92 shadow-[0_1px_16px_rgba(17,24,39,0.05)] backdrop-blur-xl hidden md:block">
        <div className="mx-auto h-20 max-w-[1440px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 flex">
          <Link href="/" className="group flex shrink-0 items-center gap-2.5" aria-label="MiniBrands home">
            ...
            <span className="hidden font-vl-heading text-lg font-extrabold tracking-[-0.04em] text-[#222222] sm:inline">MiniBrands</span>
          </Link>
          ...
          <form onSubmit={handleSearchSubmit} className="flex w-full basis-full md:mx-auto md:w-[580px] md:basis-auto lg:w-[680px]" role="search">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="h-12 w-full rounded-3xl border-[1.5px] border-[#ECECEC] bg-[#F5F5F8] pl-11 pr-4 text-sm text-[#222222] placeholder:text-[#9CA3AF] outline-none transition-all duration-200 focus:border-vl-primary focus:bg-white focus:shadow-[0_0_0_4px_rgba(15,127,127,0.1)]"
              />
            </div>
          </form>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Link href={wishlistHref} className="hidden min-h-11 min-w-11 items-center justify-center rounded-full text-[#6B7280] transition-all duration-200 hover:bg-vl-primary/8 hover:text-vl-primary sm:inline-flex" aria-label="Wishlist">
              <Heart aria-hidden="true" className="h-5 w-5" />
            </Link>
            <Link href="/cart" className="relative inline-flex min-h-11 min-w-11 items-center justify-center rounded-full text-[#6B7280] transition-all duration-200 hover:bg-vl-primary/8 hover:text-vl-primary" aria-label={`Cart${cartCount > 0 ? `, ${cartCount} items` : ""}`}>
