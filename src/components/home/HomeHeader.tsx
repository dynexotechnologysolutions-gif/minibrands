    ...
    <header className="sticky top-0 z-50 w-full border-b border-vl-border/80 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <button type="button" onClick={handleHeaderLocationClick} className="hidden min-h-11 items-center gap-2 rounded-vl-control px-3 text-xs font-semibold text-vl-muted transition hover:bg-vl-surface hover:text-vl-ink xl:flex" aria-label={`Delivery location: ${locationText}`}>
          ...
          <div ref={accountRef} className="relative">
            <button type="button" onClick={() => setIsAccountOpen((open) => !open)} className="inline-flex min-h-11 items-center gap-2 rounded-vl-control px-2 text-sm font-semibold text-vl-ink transition hover:bg-vl-surface sm:px-3" aria-expanded={isAccountOpen} aria-haspopup="menu">
