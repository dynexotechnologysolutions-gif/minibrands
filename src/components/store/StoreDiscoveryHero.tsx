...
export default function StoreDiscoveryHero({
  ...
  return (
    <div className="w-full py-8 sm:py-10">
      <div className="mx-auto flex w-full max-w-3xl flex-col items-stretch text-center md:items-start md:text-left">
        ...
        <p className="mt-3 w-full max-w-xl text-center text-sm leading-relaxed text-vl-muted sm:text-[15px] md:text-left">
